...
variable "client_ami" {
  description = "The AMI to use for client machines. Output from the Packer build process."
}

variable "server_ami" {
  description = "The AMI to use for server machines. Output from the Packer build process."
}
...
variable "key_material" {
  description = "Material for the AWS SSH key to be loaded on the instance at provisioning."
}
...
variable "nomad_binary" {
  ...
  default     = "https://releases.hashicorp.com/nomad/1.6.3/nomad_1.6.3_linux_amd64.zip"
}
